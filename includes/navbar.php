...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container mw-75 bg-white rounded-pill px-5 py-1 fs-6 fw-3 shadow ">
            <a class="navbar-brand" href="index.php"><img src="/ict_club/assets/img/logo.png" alt="Logo"> <!--<h2>ICT CLUB </h1>--> </a>
            ...
            <div class="login">
                <a href="admission.php"><button class="btn btn-outline-success">Get Started</button></a>
            </div>
        </div>
    </nav>
